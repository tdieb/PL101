  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_number() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, sign, digits) { return parseInt(sign.concat(digits.join("")));})(pos0, result0[0], result0[1]);
        }
        if (result0 === null) {
          pos = pos0;
        }
